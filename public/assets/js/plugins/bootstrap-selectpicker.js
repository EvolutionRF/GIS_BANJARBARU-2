    ...
    Selectpicker.prototype = {
      ...
      createDropdown: function() {
        ...
        var donebutton = this.multiple && this.options.doneButton ?
          ...
          '';
        var drop =
          '<div id="dd" class="dropdown bootstrap-select' + showTick + '">' +
          '<button id="cc" type="button" class="' + this.options.styleBase + ' dropdown-toggle" data-toggle="dropdown"' + autofocus + ' role="button">' +
